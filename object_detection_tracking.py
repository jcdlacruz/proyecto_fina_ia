...
sqlInsertCarriles = "INSERT INTO carriles (id, a, b, c) VALUES (%s, %s, %s, %s)"
...
while True:
    ...
    for track in tracker.tracks:
        ...
        text = str(track_id) + " - tipo: " + class_name
        ...
        ########## BD ##########
        val = (str(track_id), class_name, str(center_x), str(center_y))
        mycursor.execute(sqlInsertDetalle, val)
    ...
    ########## BD ##########
    val = (1, counter_A, counter_B, counter_C)
    mycursor.execute(sqlInsertCarriles, val)
